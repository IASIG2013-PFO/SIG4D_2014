...
//		int maille_observateur_j = (int)(Yobs/interval_de_maille);
		int maille_observateur_i = (int)((Xobs-Generation.x0)/interval_de_maille);
		int maille_observateur_j = (int)((Yobs-Generation.y0)/interval_de_maille);
		...
		int Xmin = (int) (Generation.x0 + mailleMin_i * interval_de_maille);
		int Ymin = (int) (Generation.y0 + mailleMin_j * interval_de_maille);
		int Xmax = (int) (Generation.x0 + (mailleMax_i + 1) * interval_de_maille); 
		int Ymax = (int) (Generation.y0 + (mailleMax_j + 1) * interval_de_maille); 
