...
public class Matrix3 {
	  ...
	  */
	  ...
	  public final Matrix3 scale( Vector3 s ) {
	          Matrix3 A = new Matrix3();
	          A.a11 = a11*s.xyz[0]; A.a12 = a12*s.xyz[1]; A.a13 = a13*s.xyz[2];
	          A.a21 = a21*s.xyz[0]; A.a22 = a22*s.xyz[1]; A.a23 = a23*s.xyz[2];
	          A.a31 = a31*s.xyz[0]; A.a32 = a32*s.xyz[1]; A.a33 = a33*s.xyz[2];      
	          return A;
	  }
	 ...
	 /**
	  ...
	  public static Vector3 transposeVectorAndMultiply( final Vector3 v, final Matrix3 A, final Vector3 r ){
	    ...
	    double t1 = v.xyz[0]*A.a11+v.xyz[1]*A.a21+v.xyz[2]*A.a31;
	    double t2 = v.xyz[0]*A.a12+v.xyz[1]*A.a22+v.xyz[2]*A.a32;
	    double t3 = v.xyz[0]*A.a13+v.xyz[1]*A.a23+v.xyz[2]*A.a33;
	  ...
	  public static Vector3 multiply( final Matrix3 A, final Vector3 v, final Vector3 r ) {
	    ...
	    double t1 = v.xyz[0]*A.a11+v.xyz[1]*A.a12+v.xyz[2]*A.a13;
	    double t2 = v.xyz[0]*A.a21+v.xyz[1]*A.a22+v.xyz[2]*A.a23;
	    double t3 = v.xyz[0]*A.a31+v.xyz[1]*A.a32+v.xyz[2]*A.a33;
